package jigsawtest.multimapping;
...
public class MapperTest {
  ...
  /**
   * Dieser Test stellt sicher, dass ein Quellfeld auf mehrere Zielfelder gemappt werden darf. Dies wird benötigt, um
   * Objektassoziationen aufzulösen
   */
  @Test
